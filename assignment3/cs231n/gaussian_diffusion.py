...
class GaussianDiffusion(nn.Module):
    ...
    def predict_start_from_noise(self, x_t, t, noise):
        ...
        coeff1 = extract(self.sqrt_alphas_cumprod, t, x_t.shape)
        coeff2 = extract(self.sqrt_one_minus_alphas_cumprod, t, x_t.shape)
        x_start = (x_t - coeff2 * noise) / coeff1
        ####################################################################
        return x_start
    ...
    def predict_noise_from_start(self, x_t, t, x_start):
        ...
        coeff1 = extract(self.sqrt_alphas_cumprod, t, x_t.shape)
        coeff2 = extract(self.sqrt_one_minus_alphas_cumprod, t, x_t.shape)
        pred_noise = (x_t - coeff1 * x_start) / coeff2
        ####################################################################
        return pred_noise
    ...
    def q_sample(self, x_start, t, noise):
        ...
        ####################################################################
        coeff1 = extract(self.sqrt_alphas_cumprod, t, x_start.shape)
        coeff2 = extract(self.sqrt_one_minus_alphas_cumprod, t, x_start.shape)
        x_t = coeff1 * x_start + coeff2 * noise
        ####################################################################
        return x_t
