...
class Unet(nn.Module):
    def __init__(
        ...
        for ind, (dim_in, dim_out) in enumerate(in_out_ups):
            ...
            up_block = nn.ModuleList([
                ...
                ResnetBlock(dim_in + dim_out, dim_out, context_dim=context_dim),
    ...
    def cfg_forward(self, x, time, model_kwargs={}):
        ...
        uncond_output = self.forward(x, time, model_kwargs)
        # Combine outputs using classifier-free guidance formula
